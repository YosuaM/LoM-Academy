---
title: 'Parking Wars '
description: 'Guide for Parking Wars'
pubDate: 'Oct 07 2024'
section: 'Guides'
...
import MountRewardsTable from "@Components/en/guides/MountRewardsTable.astro";
...
<MountRewardsTable id="parking-mounts-rewards-table" />
